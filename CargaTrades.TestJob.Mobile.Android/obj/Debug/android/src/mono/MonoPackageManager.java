...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "CargaTrades.TestJob.Mobile.Android.dll" comes first in this list. */
		"CargaTrades.TestJob.Mobile.Android.dll",
		"CargaTrades.TestJob.Mobile.dll",
		"FormsViewGroup.dll",
		"Newtonsoft.Json.dll",
